...
export default function SignIn() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus({ type: 'success', message: `Welcome back, ${result.user.name}! Redirecting...` });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-white">
      ...
      >
        <div className="mb-12">
          <h1 className="text-3xl font-light tracking-tight text-zinc-900">Sign in</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-[10px] uppercase tracking-widest font-semibold text-zinc-400 hover:text-zinc-900 transition-colors">
                Forgot?
              </a>
            </div>
            <input
